document.addEventListener('DOMContentLoaded', () => {
    ...
    function createCard(podcast) {
        ...
        episodeCount.innerText = `Episods: ${podcast.episodeCount}`;
    ...
    function addToQueue(episode) {
        ...
        removeBtnIcon.className = 'fas fa-list';
    ...
    const searchContainer = document.querySelector('.search-containeer');
    ...
    // Skip forward or backwards 15 sec
